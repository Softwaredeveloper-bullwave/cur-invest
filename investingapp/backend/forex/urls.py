...
urlpatterns = [
    ...
    path('forex/pairs/<str:pair_id>/options/', views.ForexOptionChainView.as_view(), name='forex-pair-options'),
    path('forex/options/', views.ForexOptionChainView.as_view(), name='forex-options'),
