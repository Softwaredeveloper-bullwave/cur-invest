...
urlpatterns = [
    ...
    path('crypto/assets/<str:asset_id>/options/', views.CryptoOptionChainView.as_view(), name='crypto-asset-options'),
    path('crypto/options/', views.CryptoOptionChainView.as_view(), name='crypto-options'),
